...
spurgt om sine naboer. Et {\tt World.Place} objekt kan også indeholde
...
skal benyttes når finker skal få afkom og møde andre finker.
...
elementer - finde på en mere effektiv implementation, hvor vi i {\tt
