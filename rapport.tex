...
I opgaven formuleringen var der lagt op til at man gjorde hovedvinduet
til en {\tt Observer} og lod dette kalde tegne-metoder på {\tt
  AreaPanel}.  Dette har vi dog afviget fra og lavet {\tt AreaPanel}
selv til en {\tt Observer} som selv sørger for at blive opdateret når
biotopen ændres. Dette gør at det på et senere tidspunkt bliver
nemmere at udskifte hvordan biotopen bliver vist. Hvis man eksempelvis
